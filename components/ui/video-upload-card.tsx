...
export function VideoUploadCard({
  ...
  const currentFile = uploadedFile !== undefined ? uploadedFile : internalUploadedFile;
  const currentVideoUrl = videoUrl !== undefined ? videoUrl : internalVideoUrl;
  ...
  const handleDrop = useCallback((e: React.DragEvent) => {
    ...
    if (videoFile) {
      if (uploadedFile === undefined) {
        setInternalUploadedFile(videoFile);
      }
      setIsUploading(true);
  ...
  }, [uploadedFile, videoUrl, onFileSelect]);
  ...
  const handleRemoveFile = useCallback(() => {
    ...
    if (videoUrl === undefined && internalVideoUrl) {
    ...
    // Call external handler
    onFileRemove?.();
  }, [uploadedFile, videoUrl, internalVideoUrl, onFileRemove]);
        ...
        <div className="flex flex-col justify-center space-y-8 p-6">
          <div className="relative w-full mx-auto">
            ...
            >
              ...
              >
                {/* Empty children - the upload area will show the upload icon */}
              </UploadCardBase>
